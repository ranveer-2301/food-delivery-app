...
const socialIcons = [
  { icon: FaFacebookF, link: 'https://facebook.com', label: 'Facebook', color: '#3b5998' },
  ...
  { icon: FaLinkedinIn, link: 'https://linkedin.com', label: 'LinkedIn', color: '#0077B5' },
];
...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#24211C] text-amber-100 py-12 px-4 sm:px-6 relative overflow-hidden">
      <div className="max-w-7xl mx-auto relative z-10">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-2.5 rounded-lg bg-amber-50/5 border-2 border-amber-400/30 focus:outline-none
                    focus:border-amber-400 focus:ring-4 focus:bg-amber-400/20 transition-all duration-300 placeholder-amber-200/50 pr-24"
                />
                <button
                  type="submit"
                  className="absolute right-1 top-1 bg-gradient-to-br from-amber-300 via-orange-500 to-amber-600 text-white px-4 py-2 rounded-full
                    flex items-center gap-1.5 shadow-lg hover:shadow-amber-400/30 transition-all duration-500"
                >
                  <span className="font-bold text-sm tracking-wide transition-transform duration-300 group-hover:-translate-x-1">
                    Join Now
                  </span>
                  <BiChevronRight className="text-xl flex-shrink-0" />
                </button>
              </div>
            </form>
          </div>
              ...
              <div className="flex space-x-4">
                {socialIcons.map(({ icon: Icon, link, color, label }, idx) => (
                  <a
                    ...
                    className="text-2xl bg-amber-400/10 p-3 rounded-full hover:bg-amber-400/20 transition-all hover:scale-x-110 duration-300 relative group"
                    style={{ color }}
                  >
                    <Icon className="hover:scale-125 transition-transform" />
                    <span className="absolute -bottom-8 left-1/2 -translate-x-1/2 bg-amber-400 text-black px-2 py-1 rounded text-sm font-bold opacity-0 group-hover:opacity-100 transition-opacity">
                      {label}
                    </span>
                  </a>
                ))}
        ...
        <div className="border-t border-amber-800 pt-8 text-center">
          ...
          <div className="group inline-block">
            <a
              href="https://github.com/ranveer-2301"
              target="_blank"
              rel="noopener noreferrer"
              className="bg-gradient-to-r from-amber-400 via-amber-500 to-amber-400 bg-clip-text text-transparent font-sacramento hover:text-purple-300 transition-all duration-500"
            >
              Designed by Ranveer
            </a>
          </div>
