...
import { FiHeart, FiUpload, FiStar } from 'react-icons/fi';
...
const AddItems = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.error(`Error uploading item: ${err.response?.data?.message || err.message}`);
      ...
      <div className="max-w-4xl mx-auto">
        <div className={styles.formCard}>
          ...
          <form className="space-y-6 sm:space-y-8" onSubmit={handleSubmit}>
            ...
            {/* Name */}
            <div>
              <label className="block mb-2 text-lg text-amber-400">Product Name</label>
              <input
                type="text"
                name="name"
                value={formData.name}
            ...
            {/* Description */}
            <div>
              <label className="block mb-2 text-lg text-amber-400">Description</label>
              <textarea
                name="description"
            ...
            <div className={styles.gridTwoCols}>
              <div>
                <label className="block mb-2 text-lg text-amber-400">Category</label>
                <select
                  name="category"
              ...
              <div>
                <label className="block mb-2 text-lg text-amber-400">Price</label>
            ...
            <div className={styles.gridTwoCols}>
              <div>
                <label className="block mb-2 text-lg text-amber-400">Rating</label>
              ...
              <div>
                <label className="block mb-2 text-lg text-amber-400">Popularity</label>
                <div className="flex items-center gap-4">
                  <button
                    type="button"
                    onClick={handleHearts}
                    className="text-2xl sm:text-3xl text-amber-400 hover:text-amber-300 animate-pulse"
                  >
                    <FiHeart />
                  </button>
                  <input
